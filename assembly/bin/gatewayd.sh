...
VELOCITY_HOME=$VELOCITY_HOME LOG_LEVEL=$LOG_LEVEL nohup node --max-old-space-size=4096 $args $VELOCITY_HOME/lib/Cluster.js > /dev/null &
echo "Started Gateway Daemon with PID=$!"